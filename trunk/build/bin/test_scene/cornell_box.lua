...
--material_param("glass","test_white");
...
--start
function startup(is_client,is_standalone)
	...
	if is_client and not is_standalone then 
		image_type = "netimage" 
	end
	maFilm(image_type,{
