...
CRTP_METHOD(double,addDouble,2,(IN(double,a0),IN(double,a1)))

CRTP_CONST_METHOD(double,multi,2,(IN(double,a0),IN(double,a1)))

CRTP_CONST_VOID_METHOD(print5sum,5,(IN(float , a0),IN(float,a1),IN(float,a2),IN(float,a3),IN(float,a4)))

CRTP_TEMPLATE_METHOD(1,double,template_1,2,(IN(T0,a),IN(T0&,b)))

CRTP_TEMPLATE_METHOD(2,float,template_2,2,(IN(T0,a),IN(T1,b)))

CRTP_CONST_TEMPLATE_METHOD(3,float,template_3,2,(IN(T0,a),IN(T1,b)) )

CRTP_CONST_VOID_TEMPLATE_METHOD(4,template_4,3,(IN(T0,a),IN(T1,b),IN(T2,c)) )
