...
#define EXPORT_FUNCTIONS(MOD,CLASS,NARGS,ARG_TUPLE)\
	CLASS_LIST_MEMBERS_START_##MOD(CLASS)\
	BOOST_PP_SEQ_FOR_EACH(ADD_MEMFUNC,CLASS,BOOST_PP_TUPLE_TO_SEQ(NARGS,ARG_TUPLE))\
	CLASS_LIST_MEMBERS_END
	
#define EXPORT_FUNCTIONS_N_CONST(CLASS,NARGS,ARG_TUPLE)\
			EXPORT_FUNCTIONS(OOLUA_CONST,CLASS,NARGS,ARG_TUPLE)


#define EXPORT_FUNCTIONS_N_NON_CONST(CLASS,NARGS,ARG_TUPLE)\
			EXPORT_FUNCTIONS(OOLUA_NON_CONST ,CLASS,NARGS,ARG_TUPLE)
