...
LUA_PROXY_CLASS(ParamIntNoReturn)
	OOLUA_TYPEDEFS Abstract OOLUA_END_TYPES
	LUA_MEM_FUNC(void(int),one)
	LUA_MEM_FUNC(void(int,int),two)
	LUA_MEM_FUNC(void(int,int,int),three)
	LUA_MEM_FUNC(void(int,int,int,int),four)
	LUA_MEM_FUNC(void(int,int,int,int,int),five)
	LUA_MEM_FUNC(void(int,int,int,int,int,int),six)
