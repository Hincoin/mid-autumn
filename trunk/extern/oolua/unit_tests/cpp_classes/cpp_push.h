...
public:
	...
	~Push(){delete pc_int;}
	//Push(Push const & rhs):i_(rhs.i_){}
	Push& ref(){return *this;}
	Push const & ref_const(){return *this;}
	Push* ptr(){return this;}
	Push const* ptr_const(){return this;}
	//int const * & ref_ptr_const(){return pc_int;}
	//int const*const& ref_const_ptr_const(){return pc_int;}
	...
	//int*& int_ref_ptr(){return &i_;}
	int const& int_ref_const(){return i_;}
	//int *const& int_ref_const_ptr(){return pc_int;}
