...
void convert1BitTo16Bit(const uint8* in, int16* out, int32 width, int32 height, int32 linepad, bool flip)
{
	if (!in || !out)
		return;
	...
	for (int32 y=0; y<height; ++y)
	{
		...
		{
			out[x] = *in>>shift & 0x01 ? (int16)0xffff : (int16)0x8000;
...
void convert4BitTo16Bit(const uint8* in, int16* out, int32 width, int32 height, const int32* palette, int32 linepad, bool flip)
{
	if (!in || !out || !palette)
		return;
...
void convert8BitTo16Bit(const uint8* in, int16* out, int32 width, int32 height, const int32* palette, int32 linepad, bool flip)
{
	if (!in || !out || !palette)
		return;
...
void convert16BitTo16Bit(const int16* in, int16* out, int32 width, int32 height, int32 linepad, bool flip)
{
	if (!in || !out)
		return;
...
void convert24BitTo24Bit(const uint8* in, uint8* out, int32 width, int32 height, int32 linepad, bool flip, bool bgr)
{
	if (!in || !out)
		return;
...
void convert16bitToA8R8G8B8andResize(const int16* in, int32* out, int32 newWidth, int32 newHeight, int32 currentWidth, int32 currentHeight)
{
...
void convert32BitTo32Bit(const int32* in, int32* out, int32 width, int32 height, int32 linepad, bool flip)
{
	if (!in || !out)
		return;
...
void convert_A1R5G5B5toR8G8B8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint8 * dB = (uint8 *)dP;
...
void convert_A1R5G5B5toB8G8R8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint8 * dB = (uint8 *)dP;
...
void convert_A1R5G5B5toA8R8G8B8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint32* dB = (uint32*)dP;
...
void convert_A1R5G5B5toA1R5G5B5(const void* sP, int32 sN, void* dP)
{
	memcpy(dP, sP, sN * 2);
}

void convert_A1R5G5B5toR5G6B5(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint16* dB = (uint16*)dP;
...
void convert_A8R8G8B8toR8G8B8(const void* sP, int32 sN, void* dP)
{
	uint8* sB = (uint8*)sP;
	uint8* dB = (uint8*)dP;
...
void convert_A8R8G8B8toB8G8R8(const void* sP, int32 sN, void* dP)
{
	uint8* sB = (uint8*)sP;
	uint8* dB = (uint8*)dP;
...
void convert_A8R8G8B8toA8R8G8B8(const void* sP, int32 sN, void* dP)
{
	memcpy(dP, sP, sN * 4);
}

void convert_A8R8G8B8toA1R5G5B5(const void* sP, int32 sN, void* dP)
{
	uint32* sB = (uint32*)sP;
	uint16* dB = (uint16*)dP;
...
void convert_A8R8G8B8toR5G6B5(const void* sP, int32 sN, void* dP)
{
	uint8 * sB = (uint8 *)sP;
	uint16* dB = (uint16*)dP;
...
void convert_A8R8G8B8toR3G3B2(const void* sP, int32 sN, void* dP)
{
	uint8* sB = (uint8*)sP;
	uint8* dB = (uint8*)dP;
...
void convert_R8G8B8toR8G8B8(const void* sP, int32 sN, void* dP)
{
	memcpy(dP, sP, sN * 3);
}

void convert_R8G8B8toA8R8G8B8(const void* sP, int32 sN, void* dP)
{
	uint8*  sB = (uint8* )sP;
	uint32* dB = (uint32*)dP;
...
void convert_R8G8B8toA1R5G5B5(const void* sP, int32 sN, void* dP)
{
	uint8 * sB = (uint8 *)sP;
	uint16* dB = (uint16*)dP;
...
void convert_R8G8B8toR5G6B5(const void* sP, int32 sN, void* dP)
{
	uint8 * sB = (uint8 *)sP;
	uint16* dB = (uint16*)dP;
...
void convert_R5G6B5toR5G6B5(const void* sP, int32 sN, void* dP)
{
	memcpy(dP, sP, sN * 2);
}

void convert_R5G6B5toR8G8B8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint8 * dB = (uint8 *)dP;
...
void convert_R5G6B5toB8G8R8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint8 * dB = (uint8 *)dP;
...
void convert_R5G6B5toA8R8G8B8(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint32* dB = (uint32*)dP;
...
void convert_R5G6B5toA1R5G5B5(const void* sP, int32 sN, void* dP)
{
	uint16* sB = (uint16*)sP;
	uint16* dB = (uint16*)dP;
