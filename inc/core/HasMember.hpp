...
struct TestStatic ; \
	\
	template <class U > \
	static FunctionDetector::NonStaticFunction Test( TestNonStaticNonConst<&U::Identifier>*, ... ); \
	\
	template <class U > \
	static  FunctionDetector::NonStaticFunction Test( TestNonStaticConst<&U::Identifier>*, int ); \
	\
	template <class U> \
	static  FunctionDetector::StaticFunction Test( TestStatic<&U::Identifier>*, int ); \
	\
	template <class U> \
	static FunctionDetector::NotFound Test( ... ); \
public : \
	enum { value = sizeof( Test<T>( 0, 0 ) ) - sizeof(  FunctionDetector::NotFound ) }; \
};\
//} 
