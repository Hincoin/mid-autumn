...
LUA_PROXY_CLASS(OutParamsTest)
	OOLUA_TYPEDEFS Abstract OOLUA_END_TYPES
	LUA_MEM_FUNC(void(OOLUA::in_out_p<int&>),int_ref)
	LUA_MEM_FUNC(void(OOLUA::in_out_p<int&>,OOLUA::in_out_p<int&>),two_int_refs)
	LUA_MEM_FUNC_RENAME(void(OOLUA::in_out_p<int*>),int_ptr_in_out,int_ptr)

	LUA_MEM_FUNC_RENAME(void(OOLUA::out_p<int&>),int_ref_out,int_ref)
	LUA_MEM_FUNC(void(OOLUA::out_p<int&>),int_ref_change)

	LUA_MEM_FUNC_RENAME(void(OOLUA::out_p<int*>),int_ptr_out,int_ptr)
	LUA_MEM_FUNC(void(OOLUA::out_p<int*>),int_ptr_change_pointee)

	LUA_MEM_FUNC(int(OOLUA::in_out_p<int&>,OOLUA::in_out_p<int&>),return_int_and_2_int_refs)
	LUA_MEM_FUNC(void(int*),int_ptr)
LUA_PROXY_CLASS_END
