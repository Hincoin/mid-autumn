#ifndef __INCLUDE_MA_VERTEX_PROCESSOR_HPP__
#define __INCLUDE_MA_VERTEX_PROCESSOR_HPP__
...
namespace ma{
	...
	public:
		...
		void process(unsigned count, const unsigned *indices)
		{
			if (process_func_)
	...
	private:
		...
		void (VertexProcessor<VertexType, Derived>::*process_func_)(unsigned, const unsigned*);

		template <typename VertexShader>
		void process_template(unsigned count,const unsigned* indices)
		{
